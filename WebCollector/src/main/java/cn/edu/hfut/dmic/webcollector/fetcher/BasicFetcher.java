                ...
                while (true) {
                    try {
                        ...
                        if (response == null) {
                            ...
                            HandlerUtils.sendMessage(handler, new Message(BasicFetcher.FETCH_FAILED, page), true);
                            continue;
                        }
                        ...
                        HandlerUtils.sendMessage(handler, new Message(BasicFetcher.FETCH_SUCCESS, page), true);
                    } catch (Exception ex) {
                        LogUtils.getLogger().info("Exception", ex);
                    }
                }
